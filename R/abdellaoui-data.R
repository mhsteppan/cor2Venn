#' Genetic correlations across psychiatric disorders
#'
#' Data from LDSC regression on 11 psychiatric phenotypes including substance use

#'
#' @docType data
#'
#' @usage data(abdellaouirg)
#'
